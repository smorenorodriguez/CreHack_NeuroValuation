function Events_model2(options,sub_nb)
...
Orig=[OA_behav.Output.RatingTask{:,4,1}]';
%%
...
% pmod(of onsets{n}).stuff{id of parametric modulator}
pmod(1).name{1}  = 'OrigRating'; % name of the parametric modulator
