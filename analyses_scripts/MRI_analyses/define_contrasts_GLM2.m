function Contrasts_model10(options)
...
contrasts.Orig              = {[0 1];[0 1] ;[0 1];[0 1 0]};
contrasts.OrigFGAT          = {[0 1];[0 1] ;[0 0];[0 0 0]};
contrasts.OrigFGAT1         = {[0 1];[0 0] ;[0 0];[0 0 0]};
contrasts.OrigFGAT2         = {[0 0];[0 1] ;[0 0];[0 0 0]};
contrasts.OrigFGAT2vsFGAT1  = {[0 -1];[0 1] ;[0 0];[0 0 0]};
contrasts.OrigFGAT1vsFGAT2  = {[0 1];[0 -1] ;[0 0];[0 0 0]};
contrasts.OrigFGAT2neg      = {[0 0];[0 -1] ;[0 0];[0 0 0]};
contrasts.OrigRTG           = {[0 0];[0 0]  ;[0 1];[0 0 0]};
